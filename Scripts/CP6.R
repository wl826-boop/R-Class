...
df <- read_csv("National_Health_and_Nutrition_Examination_Survey_(NHANES)_–_Vision_and_Eye_Health_Surveillance_20260130.csv")
...
pairwise.t.test(eye_data$Data_Value,
                eye_data$Age,
